...
import 'package:codec_utils/src/coders/hex/hex_coder.dart';
...
class URRegistryEthSignRequest extends Equatable implements IURRegistryRecord {
  ...
  factory URRegistryEthSignRequest.fromCborValue(CborValue cborValue) {
    ...
    return URRegistryEthSignRequest(
      ...
      address: cborAddress != null ? '0x${HexCoder.encode(cborAddress.bytes)}' : null,
  ...
  CborValue toCborValue({required bool includeTagBool}) {
    return CborMap.of(
      <CborValue, CborValue>{
        ...
        if (address != null) const CborSmallInt(6): CborBytes(HexCoder.decode(address!)),
